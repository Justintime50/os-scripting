...
main() {
    ...
    sudo bash -c "smtp.gmail.com:587 EMAIL:PASSWORD" > /etc/postfix/sasl_passwd
    echo "Please fill in the email and password in /etc/postfix/sasl_passwd, press any button to continue"
    read -rn 1
